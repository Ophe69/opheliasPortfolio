    ...
    <div className="HomePage">
      <header className="hero">
        ...
        <p className="h-sub-text">
          ...
          je code depuis presque deux ans, d'abord en solo puis en me formant au
          sein de
          <strong>
          ...
          <br />
          <br /> Aujourd'hui j'aimerai m'investir dans un projet, trouver{" "}
          <strong>une entreprise mais surtout une équipe </strong> au service de
          qui mettre mes compétences et surtout <br />
          <strong>continuer, encore et toujours à apprendre!</strong>
        </p>
        <div className="icons">
          <a
            href="https://www.linkedin.com/in/ophélia-tagbo"
